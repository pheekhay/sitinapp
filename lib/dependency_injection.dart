...
Future<void> initDep() async {
  getDep.registerFactory<UserDatabaseServiceInterface>(
      () => UserDatabaseService());
  getDep.registerFactory<RestaurantDatabaseServiceInterface>(
      () => RestuarantDatabaseService());
  ...
  getDep.registerFactory(
      () => ReservationBloc(reservationDb: getDep(), userDb: getDep()));
