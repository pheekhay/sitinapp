...
class ReservationsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final userid = (context.read<UserBloc>().state as LoadedUser).user!.id;
      ...
      child: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            BlocBuilder<ReservationActionBloc, ReservationActionState>(builder: (context, state) {
                                  ...
                                  trailing: Column(
                                    ...
                                    children: [
                                      ...
                                      loaded.reservations![i].customerStatus == CustomerStatus.absent &&
                                          ...
                                          ? TextButton(
                                              onPressed: () {
                                                context.read<ReservationActionBloc>().add(ReservationActionEvent.arrived(loaded.reservations![i].id));
                                                cancelNotifications();
                                              },
                                              child: Text(
                                                "Arrived",
